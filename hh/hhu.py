...
TEMPLATES = {
    "اللغة العربية": {
        ...
        "مؤشر الكفاءة": "أن يحدد الفكرة العامة والأفكار الأساسية ويجيب عن أسئلة الفهم ويوظف الرصيد اللغوي توظيفا سليما.",
        ...
        "سير الحصة": "تمهيد - قراءة - شرح المفردات - مناقشة - استخراج الأفكار - تطبيق.",
        "التقويم": "تقويم شفهي وكتابي من خلال أسئلة مباشرة وتمارين تطبيقية قصيرة.",
        "الوضعية الإدماجية": "يوظف المتعلم التعلمات الجديدة في نشاط إدماجي مناسب.",
        "الملاحظات": "مراعاة الفروق الفردية وتشجيع المشاركة."
    },
    "الرياضيات": {
        ...
        "وضعية الانطلاق": "طرح وضعية إشكالية قصيرة مرتبطة بحياة المتعلم.",
        "سير الحصة": "عرض الوضعية - البحث - المناقشة - استخلاص القاعدة - تطبيقات.",
        "التقويم": "تقويم مرحلي أثناء الإنجاز ثم تقويم نهائي بتمارين تطبيقية.",
        "الوضعية الإدماجية": "حل وضعية مركبة تستدعي توظيف التعلمات المكتسبة.",
    ...
    "العلوم الطبيعية": {
        ...
        "الوسائل": "الكتاب المدرسي، صور، مجسمات، وثائق علمية.",
        "وضعية الانطلاق": "عرض صورة أو وضعية علمية تثير تساؤلات التلاميذ.",
        "سير الحصة": "ملاحظة - فرضيات - نشاط - تحليل - استنتاج - تثبيت.",
        "التقويم": "تقويم عبر أسئلة تحليلية وتوظيف النتائج في وضعيات بسيطة.",
        "الوضعية الإدماجية": "إنجاز نشاط يربط بين المفاهيم العلمية وواقع المتعلم.",
...
class NotesApp:
    ...
    def build_ui(self):
        ...
        tk.Label(header, text="واجهة احترافية مع قوالب جاهزة وتصدير Word", font=("Arial", 11), bg=BG, fg=MUTED).pack(pady=4)
    ...
    def refresh_table(self):
        ...
        for idx, note in enumerate(self.notes):
            full_text = " ".join(str(v) for v in note.values())
