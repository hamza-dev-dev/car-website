...
class GoldSilverApp:
    ...
    def build_sales_tab(self):
        ...
        tk.Button(form, text="إنشاء وصل", command=self.open_invoice_tab, bg="#0f766e", fg="white", font=("Arial", 12, "bold"), padx=10, pady=8, relief="raised", bd=3).grid(row=7, column=0, columnspan=2, sticky="ew", pady=4)
