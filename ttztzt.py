...
class GoldSilverApp:
    ...
    def build_inventory_tab(self):
        ...
        tk.Button(bg="#facc15", fg="black", activebackground="#eab308", form, text="إضافة للمخزون", command=self.add_inventory_item, bg="#2563eb", fg="white", font=("Arial", 12, "bold"), padx=10, pady=8, relief="raised", bd=3).grid(row=7, column=0, columnspan=2, sticky="ew", pady=8)
        ...
        tk.Button(bg="#facc15", fg="black", activebackground="#eab308", btns, text="حذف المحدد", command=self.delete_inventory_item, bg="#dc2626", fg="white", font=("Arial", 12, "bold"), padx=10, pady=8, relief="raised", bd=3).pack(side="right", padx=4)
        tk.Button(bg="#facc15", fg="black", activebackground="#eab308", btns, text="تحديث الجداول", command=self.refresh_all, bg="#475569", fg="white", font=("Arial", 12, "bold"), padx=10, pady=8, relief="raised", bd=3).pack(side="right", padx=4)
    ...
    def build_sales_tab(self):
        ...
        tk.Button(bg="#facc15", fg="black", activebackground="#eab308", form, text="تنفيذ العملية", command=self.execute_transaction, bg="#16a34a", fg="white", font=("Arial", 12, "bold"), padx=10, pady=8, relief="raised", bd=3).grid(row=6, column=0, columnspan=2, sticky="ew", pady=8)
        tk.Button(bg="#facc15", fg="black", activebackground="#eab308", form, text="إنشاء وصل", command=self.open_invoice_tab, bg="#0f766e", fg="white", font=("Arial", 12, "bold"), padx=10, pady=8, relief="raised", bd=3).grid(row=7, column=0, columnspan=2, sticky="ew", pady=4)
    ...
    def build_invoice_tab(self):
        ...
        tk.Button(bg="#facc15", fg="black", activebackground="#eab308", top, text="حفظ الفاتورة TXT", command=self.save_invoice_file, bg="#2563eb", fg="white", font=("Arial", 12, "bold"), padx=10, pady=8, relief="raised", bd=3).pack(side="right", padx=4)
        tk.Button(bg="#facc15", fg="black", activebackground="#eab308", top, text="طباعة", command=self.print_invoice, bg="#16a34a", fg="white", font=("Arial", 12, "bold"), padx=10, pady=8, relief="raised", bd=3).pack(side="right", padx=4)
...
""".strip()
    ...
    def open_invoice_tab(self):
        if not self.invoice_text:
            messagebox.showwarning("تنبيه", "نفذ عملية أولاً لإنشاء وصل")
            return
        self.invoice_box.delete("1.0", tk.END)
        self.invoice_box.insert(tk.END, self.invoice_text)
